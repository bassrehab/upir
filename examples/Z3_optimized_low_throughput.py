...
class QueueWorker:
    ...
    def __init__(self):
        ...
        self.batch_size = 11  # Z3 optimized
        self.workers = 36        # Z3 optimized
        self.timeout_ms = 3000
        
        # Achieved throughput: 3960 req/s
...
# - Throughput >= 3960 req/s
# - Resource usage minimized (batch_size + workers = 47)
